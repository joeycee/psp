    ...
    <div class="shell">
      <div class="footer-grid">
        ...
        <div>
          ...
          <p>Email: <a href="mailto:${escapeHtml(company.email)}">${escapeHtml(company.email)}</a></p>
      ...
      `<div class="contact-grid">
        ...
        <div class="contact-card">
          ...
          <div class="contact-stack">
            <div>Contact us at <a href="mailto:${escapeHtml(company.email)}">${escapeHtml(company.email)}</a> for details on pricing, stock, and where to purchase or install the PSP SurfKit.</div>
      ...
      `<div class="trust-grid">
        ...
        <article class="contact-card trust-card">
          ...
          <div class="contact-stack">
            ...
            <div><strong style="display:block;margin-bottom:4px;color:var(--text);">Email</strong><a href="mailto:${escapeHtml(company.email)}">${escapeHtml(company.email)}</a></div>
            <div><strong style="display:block;margin-bottom:4px;color:var(--text);">Phone</strong>${escapeHtml(company.phone)}</div>
            <div><strong style="display:block;margin-bottom:4px;color:var(--text);">International</strong>${escapeHtml(company.phoneIntl)}</div>
          </div>
        </article>
